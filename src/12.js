    ...
    return (
        <>
            ...
            <div className="row mt-2">
                <div className="col">
                    <input type="text" className="form-control" placeholder="username" aria-label="First name" value={username} onChange={handleUsernameChange} />
                </div>
                <div className="col">
                    <input type="text" className="form-control" placeholder="password" aria-label="Middle name" value={password} onChange={handlePasswordChange} />
                </div>
